            ...
            <ul className="ul-bullet-style">
              <li className="main-list-item">
                ...
                <ol>
                  ...
                  <li>
                    <p> Nesilankykite pirtyje ar soliariume.</p>
                  </li>
                  <li>
                    <p>
                      Makiažą akių srityje tepkite ar valykite neliečiant
                      antakių.
                    </p>
                  </li>
                  ...
                  <li>
                    <p>Henna dažais nedažome mažiausiai mėnesį laiko</p>
                  </li>
                  <li>
                    <p>
                      Naudokite aliejus, drėkinamuosius serumus. Po procedūros
                      būtina tepti aliejus minimaliai 3 savaites, o dar geriau
                      visada. Rekomenduojami aliejai: avokado, vynuogių
                      kauliukų, persikų, jojoba, migdolu, argano (tie, kurie
                      drėkina plaukelį).
                    </p>
                  </li>
                </ol>
